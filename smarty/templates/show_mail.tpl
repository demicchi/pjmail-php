...
<html lang="ja">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div>mail address: <a href="mailto:{$project|escape}{$separator|escape}{$ticket|escape}@{$domain|escape}">{$project|escape}{$separator|escape}{$ticket|escape}@{$domain|escape}</a></div>
