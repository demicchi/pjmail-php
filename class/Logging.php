...
class Logging
{
    ...
    {
        $path = match (constant('PJMAIL_RUNNING_MODE')) {
            "ui" => Config::getConfig("logging/file/ui"),
            "mail" => Config::getConfig("logging/file/mail"),
            default => throw new \Exception("[FATAL] PJMAIL_RUNNING_MODE(" . constant('PJMAIL_RUNNING_MODE') . ") is invalid."),
        };
        return Common::getAbsolutePath($path);
    }
